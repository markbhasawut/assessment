...
class UserTicketServiceImpTest {
    ...
    void testBuyLottery() {
        ...
        assertThrows(BadRequestException.class, () -> userTicketServiceImp.buyLottery(USER_ID, TICKET));
    ...
    void testSellLottery() {
        ...
        assertThrows(InvalidUserTicketExceptionHandling.class, () -> userTicketServiceImp.sellLottery(USER_ID, TICKET));
    }
}